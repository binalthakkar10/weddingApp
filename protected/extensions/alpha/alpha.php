...
class alpha extends CValidator
{
	...
	protected function validateAttribute($object,$attribute)
	{
		...
		$message = $this->message ? $this->message : Yii::t('alpha', '{attribute} can only contain word characters');
	...
	public function clientValidateAttribute($object,$attribute)
	{
		...
		$pattern = $this->elaboratePattern();
		// get the error message
		$message = $this->message ? str_replace('{attribute}', $attribute, $this->message) : Yii::t('alpha', '{attribute} can only contain word characters', array('{attribute}' => $attribute));
