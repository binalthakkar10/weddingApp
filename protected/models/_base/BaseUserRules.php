...
abstract class BaseUserRules extends GxActiveRecord {
	...
	public function rules() {
		return array(
			...
			array('role_id, role_desc, privileges_controller, privileges_actions, permission, permission_type', 'default', 'setOnEmpty' => true, 'value' => null),
			array('id, role_id, module_id, role_desc, privileges_controller, privileges_actions, permission, permission_type', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations() {
		return array(
			...
			'userRulesMenus' => array(self::HAS_MANY, 'UserRulesMenu', 'rule_id'),
		);
	}
