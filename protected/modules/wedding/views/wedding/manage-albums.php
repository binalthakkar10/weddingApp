				...
				<section class="slider">
					<div id="slider" class="flexslider carousel">
						...
						<ul class="slides delgridly">
							<li style="display: none;">slide one</li>
...
/* add the custom album*/
  ...
  $('.gridly').append("<li class='mbox brick' id='recordsArray_"+totalLength+"'><img class='mngimg' src='<?php echo Yii::app()->getBaseUrl(true);?>/images/custom_album.png'/><img class='mng-h' src='<?php echo Yii::app()->getBaseUrl(true);?>/images/custom_album_white.png'/><span>"+customField+"</span><a href='javascript:;' class='mng-closebtn temporary'><img src='<?php echo Yii::app()->getBaseUrl(true); ?>/images/close-icon.png'/></a></li>");
  	$.ajax({
		type: 'POST',
...
<script>
 $(window).load(function() {
         $("#activemanagealbum").addClass("active");
         });
</script>    