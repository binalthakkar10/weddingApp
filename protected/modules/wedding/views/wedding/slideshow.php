...
<div class="slider_control">
    <a class="play_button">
        <img id="pauseplay" src="<?php echo Yii::app()->getBaseUrl(false);?>/images/pause.png"/>
    </a>
    	...
    	<div id="box" class="menu option_one">
        	...
        	<div class="Albums">
                ...
                <div class="category_function">
                	<!--Honey moon Box -->
                	<div class="honeymoon  category active pull-left">
                    	<img src="<?php echo Yii::app()->getBaseUrl(false);?>/images/select-photo-one.png" >
                    	<!--<span class="count pull-right">1</span>
                        <div class="clearfix"></div>
                        <div class="image">
                        	<img class="main_img" src="images/honeymoon.png" ><img class="hover" src="images/honeymoon_hover.png"  />
                        </div>
                    ...
                    <div class="reception category pull-left">
                    	<img src="<?php echo Yii::app()->getBaseUrl(false);?>/images/select-photo-two.png" >
                    	<!--<span class="count pull-right">1</span>
                        <div class="clearfix"></div>
                        <div class="image">
                    ...
                    <div class="ceraymany category pull-left">
                    	<img src="<?php echo Yii::app()->getBaseUrl(false);?>/images/select-photo-three.png" >
                    	<!--<span class="count pull-right">1</span>
                        <div class="clearfix"></div>
                        <div class="image">
       		...
       		<div class="Albums">
                ...
                <div class="category_function Setting_tab ">
                    ...
                    <div class="option four pull-left">
                    	<div class="title_option">Order</div>
                        <div class="input_option">
                        	<select class="selectpicker">
                ...
                <div class="category_function Comment_tab ">
                	...
                	<div class="comment_part">
                    	...
                    	<div class="person_image pull-left">
                        	<img src="<?php echo Yii::app()->getBaseUrl(false);?>/images/comment_person.png" >
                        </div>
                        <!--Person Of Commnet -->
...
<!--Slide Title -->    
<span class="close"><img src="<?php echo Yii::app()->getBaseUrl(false);?>/images/pop_up_close.png" /></span><br /></span></li>
<!--Slide Title --> 
...
$(window).load(function() {
         $("#activeslideshow").addClass("active");
         });
</script>  
