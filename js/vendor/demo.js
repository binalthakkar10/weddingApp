...
$(function () {
    ...
    var result = $('#result');
        ...
        replaceResults = function (img) {
            ...
            if (!(img.src || img instanceof HTMLCanvasElement)) {
                //content = $('<span>Loading image file failed</span>');
				 ...
				 $.fancybox({	
				content: result.html($('<a target="_blank" id="prdct_img">').append(img).append($('<button type="button" id="crop">Crop</button>'))),
				 afterShow:function(){
               ...
               // content = $('<a target="_blank" id="prdct_img">').append(img);
        ...
        if (img.getContext) {
            	...
            	$("#prdct_img").find('canvas').attr("id","imageMap");
                  actionsNode.show();
