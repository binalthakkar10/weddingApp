...
$instagram = new Instagram(array(
	  		'apiKey'      => 'b97aea6621af4de4938e26577f7dd9b5',
	  		'apiSecret'   => 'bb5e80c77e2d420e8b36abf41f8dd582',
...
<div id="st-container" class="st-container main animsition" data-animsition-in="fadeIn" data-animsition-out="fadeOut">	
    <nav class="st-menu st-effect-12" id="menu-12">
        ...
        <ul>
            <li><a class="icon icon-data" href="#" data-target="st-container">Home</a></li>
            <li><a class="icon icon-location menu-item" href="#" data-target="about-us">About</a></li>
            <li><a class="icon icon-location menu-item" href="#" data-target="">Services</a></li>
            <li><a class="icon icon-study menu-item" href="#" data-target="">Products</a></li>
            <li><a class="icon icon-photo menu-item" href="#" data-target="">Career</a></li>
            <li><a class="icon icon-wallet menu-item" href="#" data-target="contact-footer">Contact Us</a></li>
        </ul>
    </nav>
	<!--st-pusher -->
    <div class="st-pusher">
            ...
            <div class="st-content-inner"><!-- extra div for emulating position:fixed of the menu -->
                ...
                <section class="banner story" data-speed="4" data-type="background">    	
                    ...
                    <header class="active">
                            ...
                            madespecifically for your <span>wedding.</span></span>
                            ...
                            <?php } ?>
                             <a href="#" class="dark-but cust-pop-trigger" data-cuspop="register"> I'M A GUEST</a>
                              <span class="member">Already a Member? 
                             	...
                             	<?php if(isset($_SESSION['uid']) && !empty($_SESSION['uid'])){ ?>
                             		<a class="login cust-pop-trigger" id="Logout" data-cuspop="login" href="#">LOGOUT</a>
                             	<?php }else{?>
                             		<a class="login cust-pop-trigger" data-cuspop="login" href="#">LOGIN</a></span>	
                             	<?php }  ?> 
