                        ...
                        <div class="container">
                            ...
                            <div class="trending">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="trendimg"><img src="<?php echo Yii::app()->getBaseUrl(true)?>/images/bridemaid.jpg"></div>
                                    <div class="overlay-box">The 6 Types of Bridesmaids<br> (know any?)</div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="trendimg"><img src="<?php echo Yii::app()->getBaseUrl(true)?>/images/bride-white.jpg"></div>
                                    <div class="overlay-box">13 Things All Brides Will Eventually Discover</div>
                                </div>
                                <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                    <div class="trendimg"><img src="<?php echo Yii::app()->getBaseUrl(true)?>/images/candels.jpg"></div>
