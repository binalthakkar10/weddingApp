...
class SystemConfigController extends AdminCoreController {
	...
	public function actionCreate() {
		$this->pageTitle = "Create System Config || Lets Go Out";
	...
	public function actionUpdate($id) {
		$this->pageTitle = "Update System Config || Lets Go Out";
		$model = $this->loadModel($id, 'SystemConfig');
		...
		if (isset($_POST['SystemConfig'])) {
			...
			if ($model->save()) {
				Yii::app()->admin->setFlash('success', Yii::t("messages","Succesfully update system config.!"));
				$this->redirect(array('admin'));
			}
		}
	...
	public function actionAdmin() {
		$this->pageTitle = "Manage System Config || Lets Go Out";
