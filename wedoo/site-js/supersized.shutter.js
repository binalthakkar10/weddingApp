	...
	theme = {
		...
		----------------------------*/
	 	playToggle : function(state){
			...
			//	$("#pauseplay").parent().addClass("pause").removeClass("play");

	 		}else if (state == 'pause'){
	 			// If image, swap to play
	 			if ($(vars.play_button).attr('src')) $(vars.play_button).attr("src", vars.image_path + "play_back.png");
        		if (api.options.progress_bar && vars.is_paused)$(vars.progress_bar).stop().css({left : -$(window).width()});

				//$("#pauseplay").parent().addClass("play").removeClass("pause");
	 		}
